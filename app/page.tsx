...
export default function NeuropsicologiaSite() {
  ...
  return (
    <>
      <Head>
        <title>Rodrigo Lübke | Avaliação Neuropsicológica em Sinop/MT</title>
        <meta name="description" content="Avaliação neuropsicológica com o psicólogo Rodrigo Lübke (CRP 18/04819) em Sinop/MT. Especialista em neuropsicologia, atendimento para adultos e crianças. Clareza diagnóstica, laudo detalhado e plano terapêutico personalizado." />
        <meta name="keywords" content="Rodrigo Lübke, neuropsicologia, avaliação neuropsicológica, psicólogo Sinop, laudo neuropsicológico, TDAH, TEA, dificuldades de aprendizagem, Sinop MT, psicologia infantil, psicologia adulto, diagnóstico psicológico, terapia, saúde mental" />
        <meta property="og:title" content="Rodrigo Lübke | Avaliação Neuropsicológica em Sinop/MT" />
        <meta property="og:description" content="Avaliação neuropsicológica com especialista em Sinop/MT. Atendimento para adultos e crianças. Clareza diagnóstica e plano terapêutico personalizado." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://rodrigolubke.com.br" />
        <meta property="og:image" content="/logorodrigo.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Rodrigo Lübke | Avaliação Neuropsicológica em Sinop/MT" />
        <meta name="twitter:description" content="Avaliação neuropsicológica com especialista em Sinop/MT. Atendimento para adultos e crianças. Clareza diagnóstica e plano terapêutico personalizado." />
        <meta name="twitter:image" content="/logorodrigo.png" />
        <link rel="canonical" href="https://rodrigolubke.com.br" />
      </Head>
              ...
              <div className="flex flex-col lg:flex-row gap-8 md:gap-12 lg:gap-16 items-center">
                ...
                <div className="text-center lg:text-left relative order-1 lg:order-1 w-full lg:w-1/2">
                  ...
                  <h1 className="text-4xl lg:text-5xl xl:text-6xl font-light mb-8 leading-tight" style={{ color: "#002147" }}>
                    Psicólogo Rodrigo Lübke - Avaliação Neuropsicológica
                  </h1>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-14 relative">
                ...
                <h2 className="text-3xl lg:text-4xl font-light mb-8" style={{ color: "#002147" }}>
                  Sobre Rodrigo Lübke - Psicólogo e Neuropsicólogo
                </h2>
                <div className="w-24 h-1 bg-gray-200 mx-auto rounded-full"></div>
              </div>
          ...
          <div className="container mx-auto px-4 lg:px-6">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl lg:text-4xl font-light text-center mb-20" style={{ color: "#fff" }}>
                Depoimentos sobre Avaliação Neuropsicológica
              </h2>
